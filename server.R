...
server <- function(input, output, session) {
  ...
  output$quick_quide_intro <- renderText({"
    ...
    <br><br>
    <p>
    1) <b>Summarize:</b> Get variant statistics from a VCF file<br><br>
    2) <b>Compare:</b> Differentiate the variants in two VCF files<br><br>
    3) <b>Interface:</b> View, search, sort, inspect, and filter genetic variants in a VCF file
    <br> <br><br>
  ...
  output$quick_quide_content <- renderText({"
    
    <h5>Summarize Submodules</h5>
    <p>
    <li>Upload VCF: Click the browse button and upload a VCF file.</li>
    <li>Overall Summary: Get an overall summary of the variants in each variant type.</li>
    <li>Summary Distribution: Visualize the distribution of variant metrics in various contigs.</li>
    ...
    <li>Venn Diagram: View area-proportional Venn diagram with the no. of common and unique variants.</li>
    <li>Overall Summaries: Get overall summaries for unique and common variant types.</li>
    <li>Summary Distribution: Visualize the comman and unique variant types along contigs.</li>
    <li>Variants Distribution: Visualize the unique and common variants in genomic ranges.</li>
    <li>Download Summaries: Extract the results as a tabular dataset for further analysis.</li>
    <li>Download Variants: Extract the common and unique variants for further analysis.</li>
    </p>
    
    <h5>Interface Submodules</h5>
    <p>
    <li>Upload VCF: Click the browse button and upload a VCF file.</li>
    <li>Meta-Information: View, search, and download the meta-information from the file.</li>
    <li>Sort Variants: Sort variants in ascending order. Add IDs as CHROM_POS_REF_ALT.</li>
    ...
    <li>Search-based Filtering: View the file contents and filter based on keyword search.</li>
    </p>
  ...
  Venkatesh Kamaraj, Himanshu Sinha, SCI-VCF: a cross-platform GUI solution to summarize, compare, inspect and visualize the variant call format, NAR Genomics and Bioinformatics, Volume 6, Issue 3, September 2024, lqae083,
    <a target=\"_blank\" href=\"https://doi.org/10.1093/nargab/lqae083\">https://doi.org/10.1093/nargab/lqae083</a>
    </font>") 
